...
namespace SHV
{
	...
	namespace GAMEPLAY
	{
		...
		static void LOAD_CLOUD_HAT(char* type, float transitionTime) { invoke<Void>(0xFC4842A34657BFCB, type, transitionTime); } // 0xFC4842A34657BFCB 0xED88FC61
		static void _0xA74802FB8D0B7814(char* p0, float p1) { invoke<Void>(0xA74802FB8D0B7814, p0, p1); } // 0xA74802FB8D0B7814 0xC9FA6E07
		static void UNLOAD_ALL_CLOUD_HATS() { invoke<Void>(0x957E790EA1727B64); } // 0x957E790EA1727B64 0x2D7787BC
	...
	namespace STREAMING
	{
		...
		static void SET_FOCUS_POS_AND_VEL(float x, float y, float z, float p3, float p4, float p5) { invoke<Void>(0xBB7454BAFF08FE25, x, y, z, p3, p4, p5); } // 0xBB7454BAFF08FE25 0x14680A60
	...
	namespace UI
	{
		...
		static void SET_RADAR_ZOOM_PRECISE(float p0) { invoke<Void>(0xBD12C5EEE184C337, p0); } // 0xBD12C5EEE184C337 0xDCA3F423
		static void SET_RADAR_ZOOM(int p0) { invoke<Void>(0x096EF57A0C999BBA, p0); } // 0x096EF57A0C999BBA 0x2A50D1A6
		static void SET_RADAR_ZOOM_TO_BLIP(Any p0, float p1) { invoke<Void>(0xF98E4B3E56AFC7B1, p0, p1); } // 0xF98E4B3E56AFC7B1 0x25EC28C0
		static void SET_RADAR_ZOOM_TO_DISTANCE(float zoomLevel) { invoke<Void>(0xCB7CC0D58405AD41, zoomLevel); } // 0xCB7CC0D58405AD41 0x09CF1CE5
		...
		static void SET_FAKE_PAUSEMAP_PLAYER_POSITION_THIS_FRAME(float x, float y) { invoke<Void>(0x77E2DD177910E1CF, x, y); } // 0x77E2DD177910E1CF 0x54E75C7D
	...
	namespace GRAPHICS
	{
		...
		static void SET_ARTIFICIAL_LIGHTS_STATE(BOOL enable) { invoke<Void>(0x1268615ACE24D504, enable); } // 0x1268615ACE24D504 0xAA2A0EAF
		...
		static void CASCADE_SHADOWS_INIT_SESSION() { invoke<Void>(0x03FC694AE06C5A20); } // 0x03FC694AE06C5A20 0x48F16186
		...
		static void CASCADE_SHADOWS_SET_CASCADE_BOUNDS_SCALE(float p0) { invoke<Void>(0x5F0F3F56635809EF, p0); } // 0x5F0F3F56635809EF 0x13D4ABC0
		...
		static void CASCADE_SHADOWS_SET_AIRCRAFT_MODE(BOOL p0) { invoke<Void>(0x6DDBF9DFFC4AC080, p0); } // 0x6DDBF9DFFC4AC080 0x9F470BE3
	...
	namespace WORLDPROBE
	{
		...
		static int START_EXPENSIVE_SYNCHRONOUS_SHAPE_TEST_LOS_PROBE(float x1, float y1, float z1, float x2, float y2, float z2, int flags, Entity entity, int p8) { return invoke<int>(0x377906D8A31E5586, x1, y1, z1, x2, y2, z2, flags, entity, p8); } // 0x377906D8A31E5586 0x8251485D
		...
		//static Any START_SHAPE_TEST_MOUSE_CURSOR_LOS_PROBE(Any p0, Any p1, Any p2, Any p3, Any p4) { return invoke<Any>(0xFF6BE494C7987F34, p0, p1, p2, p3, p4); } // 0xFF6BE494C7987F34
		static int START_SHAPE_TEST_MOUSE_CURSOR_LOS_PROBE(Vector3* startPos, Vector3* endPos, int flags, SHV::Entity excludeEntity, int options)
		{
			//return invoke<Any>(0xFF6BE494C7987F34, p0, p1, p2, p3, p4);
			return invoke<int>(0xFF6BE494C7987F34, startPos, endPos, flags, excludeEntity, options);
		} // 0xFF6BE494C7987F34
